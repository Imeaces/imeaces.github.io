...
<a href="minecraft://?addExternalServer=Imeaces-Origin|origin.imeaces.org:40233">快捷加入</a>  
...
支持版本  
: `1.21.70-1.21.73` `1.21.80-1.21.84` `1.21.90-1.21.92` `1.21.93-1.21.94`
...
你可以使用**Java版**自1.17以来的所有正式版本（1.17-1.21.10）加入服务器，但是我们推荐你使用[Java版1.19.4](https://zh.minecraft.wiki/w/Java版1.19.4)，这是服务器使用的版本。

除此之外，你还可以使用你的Minecraft **基岩版**加入服务器，只要确保使用的是此处列出的正式版本或其兼容版本：1.21.70-1.21.73，1.21.80-1.21.84，1.21.90-1.21.92，1.21.93-1.21.94。
